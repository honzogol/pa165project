...
public class AreaController {
	...
	/**
	 * Get list of Areas curl -i -X GET
	 * http://localhost:8080/pa165/rest/areas
	 *
	 * @return List<AreaDTO>
	 */
	 ...
	 * '{"name":"New Area","type":"MOUNTAINS","someMonstersSetIDontKnowHowToWrite}'
	 ...
	 * @throws ResourceAlreadyExistingException when area with given name already exists
	 */
	...
	/**
	 * Finds area with the same id and updates its attributes.
	 * Not provided values are not changed. Id is required.
	 *
	 * curl -i -X PUT -H
	 * "Content-Type: application/json" --data '{"type": "MOUNTAINS",
	 * "name": "Mountains full of Kyle Moms", "someMonstersSetIDontKnowHowToWrite}'
	 * http://localhost:8080/pa165/rest/areas/1
	 *
